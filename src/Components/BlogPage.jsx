...
import { DeleteBlog, SingleBlog } from "../Api/Services/blog";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                if (response.status === 202) {
                    ...
                    Swal.fire("Oops!", "Your file has not deleted.", "warning");
                }
            }
        });
    };
                                ...
                                <div className="flex justify-center my-4 text-white">
                                    {userId == blog?.author?._id && (
                                        <div
                                            ...
                                            className="flex justify-between items-center rounded-lg flex-row gap-2 px-3 py-3 bg-gray-800"
                                        >
                                            <svg
                                                fill="#fff"
                                                version="1.1"
